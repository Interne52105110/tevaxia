              ...
              <div className="rounded-xl border border-card-border bg-card p-6 shadow-sm">
                ...
                {selectedResult && (
                  <div className="mt-4 space-y-3">
                    ...
                    <a href={buildGeoportailViewerUrl(selectedResult.commune.commune, {
                        lat: COMMUNE_COORDS[selectedResult.commune.commune]?.[0],
                        lon: COMMUNE_COORDS[selectedResult.commune.commune]?.[1],
                    ...
                    <PAGMap
                      ...
                      labels={{
                        pagLayer: t("geoportailPagLayer"),
                        cadastreLayer: t("geoportailCadastreLayer"),
                        viewOnGeoportail: t("viewGeoportail"),
                        sourceNote: t("geoportailSourceNote"),
                        loading: t("geoportailLoading"),
                      }}
                    />
                  </div>
                )}
