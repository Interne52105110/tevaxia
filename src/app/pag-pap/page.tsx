                ...
                {selectedResult && (
                  <div className="mt-4 space-y-3">
                    ...
                    <a href={getGeoportailUrl(selectedResult.commune.commune)} target="_blank" rel="noopener noreferrer"
                      ...
                      Voir le PAG sur Geoportail.lu
                    </a>
                    <p className="text-xs text-muted text-center">Ouvre la carte Geoportail centrée sur {selectedResult.commune.commune} avec le calque PAG activé</p>
                  </div>
                )}
              </div>
