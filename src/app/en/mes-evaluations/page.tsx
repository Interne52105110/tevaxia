...
const TYPE_LABELS: Record<string, { label: string; href: string }> = {
  estimation: { label: "Estimation", href: "/en/estimation" },
  valorisation: { label: "EVS Valuation", href: "/en/valorisation" },
  capitalisation: { label: "Capitalisation", href: "/en/valorisation" },
  dcf: { label: "DCF", href: "/en/valorisation" },
  "dcf-multi": { label: "Multi-tenant DCF", href: "/en/dcf-multi" },
  frais: { label: "Acquisition costs", href: "/en/frais-acquisition" },
  "plus-values": { label: "Capital gains", href: "/en/plus-values" },
  loyer: { label: "Invested capital / Rent", href: "/en/calculateur-loyer" },
  aides: { label: "Subsidies simulator", href: "/en/simulateur-aides" },
  "achat-location": { label: "Buy vs Rent", href: "/en/achat-vs-location" },
  "bilan-promoteur": { label: "Developer appraisal", href: "/en/bilan-promoteur" },
};
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        {evaluations.length === 0 ? (
          <div className="rounded-xl border-2 border-dashed border-card-border py-16 text-center">
            ...
            <Link href="/en/valorisation" className="mt-4 inline-block rounded-lg bg-navy px-4 py-2 text-sm font-medium text-white hover:bg-navy-light transition-colors">
              Start a valuation
            </Link>
          </div>
        ) : (
