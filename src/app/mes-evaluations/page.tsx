      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 rounded-lg bg-amber-50 border border-amber-200 p-3">
          <p className="text-xs text-amber-800 leading-relaxed">
            ...
            Elles ne sont pas transmises à nos serveurs. Si vous effacez les données de navigation ou changez
            de navigateur/appareil, les évaluations seront perdues. Maximum 50 évaluations conservées.
          </p>
        </div>
      </div>
    </div>
