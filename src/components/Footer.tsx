...
export default async function Footer() {
  ...
  return (
    <footer className="border-t border-card-border bg-navy-dark text-white/75">
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="grid gap-8 break-words sm:grid-cols-2 lg:grid-cols-4">
          {/* Logo + tagline */}
          <div>
          ...
          {/* Légal */}
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider text-white/75 mb-3">{tc("legal")}</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider text-white/75 mb-3">{tn("sourcesExternes")}</h3>
            <ul className="space-y-1.5 text-sm">
              ...
              <li><a href="https://www.klima-agence.lu" target="_blank" rel="noopener external" className="hover:text-white transition-colors">Klima-Agence</a></li>
            </ul>
          </div>

          {/* Contact */}
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider text-white/75 mb-3">{tc("contact")}</h3>
        ...
        <div className="mt-8 border-t border-white/10 pt-6 text-center text-sm text-white/75">
