      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-1">
            ...
            <Link href="/pricing" className="rounded-lg px-3 py-2 text-sm font-medium text-gold hover:bg-white/10 transition-colors">
              Tarifs
            </Link>
          </nav>
        ...
        {menuOpen && (
          <nav className="lg:hidden border-t border-white/10 py-3 space-y-3">
            ...
            <Link href="/pricing" className="block rounded-lg px-3 py-2 text-sm font-medium text-gold hover:bg-white/10" onClick={() => setMenuOpen(false)}>
              Tarifs
            </Link>
          </nav>
        )}
