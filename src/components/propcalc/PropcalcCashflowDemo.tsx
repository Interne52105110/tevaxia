      ...
      <div className="mx-auto max-w-5xl px-4">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="rounded-xl bg-card border border-card-border p-5 shadow-sm lg:col-span-2">
            ...
            {countryCode === "fr" && <p className="mt-3 text-sm text-muted">{t("demoFranceTransferAssumption")} {t("demoFranceFeeScope")} <a className="underline" href="https://www.impots.gouv.fr/droits-denregistrement">DGFiP</a></p>}
          </div>
        </div>
      </div>
    </section>
