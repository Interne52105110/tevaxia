...
- Lots repris et vérifiés : frais d’acquisition/fiches agence, capitalisation et DCF, comparables et réconciliation, préparation CPE/HVAC/LENOZ/ESG/CRREM/taxonomie, prévisions hôtelières/STR, données municipales/RNPP/HPI, marché commercial publié, scénarios de prix, budgets construction/VRD, commandes PDF communes, bilan promoteur, foncier agricole, comptes/valorisation/DSCR/pré-acquisition hôteliers, dossier documentaire E‑2, comparatif hôtelier et accès aux détails au clavier.
- Restent à revoir : fonctions et hypothèses restantes hors des lots validés, observatoire et transactions hôtelières, autres modèles hôteliers/STR, modules de gestion locative/copropriété/agence, parcours authentifiés, anciennes API Java et schémas des API encore non alignés.
